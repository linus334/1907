...
<div class="head-top">
     ...
     <div class="index-pro1">
      <div class="index-pro1-list">
       ...
       <dl>
        <dt>
         <a href="{{url('/detail/'.$v->goods_id)}}"><img src="{{env('UPLOAD_URL')}}{{$v->goods_img}}" /></a>
        </dt>
        <dd class="ip-text">
         <a href="{{url('/detail/'.$v->goods_id)}}">{{$v->goods_name}}</a><span>已售：488</span>
        </dd>
        <dd class="ip-price">
         <strong>¥{{$v->goods_price}}</strong> <span>¥599</span>
        </dd>
       </dl>
        @endforeach
      </div>
